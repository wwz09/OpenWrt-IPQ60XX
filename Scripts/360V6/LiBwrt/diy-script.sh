...
git_sparse_clone mzwrt_package https://github.com/wwz09/IPQ_package luci-theme-argon luci-app-argon-config luci-app-quickstart quickstart ucl luci-theme-kucat luci-theme-design
...
# 修复 hostapd 报错
cp -f $GITHUB_WORKSPACE/scripts/360V6/LiBwrt/011-fix-mbo-modules-build.patch package/network/services/hostapd/patches/011-fix-mbo-modules-build.patch
