...
UPDATE_PACKAGE "mzwrt_package_Lite" "wwz09/mzwrt_package_Lite" "main" "" "luci-app-timecontrol luci-app-control-webrestriction luci-app-control-weburl luci-app-control-timewol"
UPDATE_PACKAGE "small" "kenzok8/small-package" "main" "" "luci-app-adguardhome adguardhome luci-app-store luci-lib-taskd"
